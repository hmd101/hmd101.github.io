...
**[al-folio](https://alshedivat.github.io/al-folio/): A simple, clean, and responsive Jekyll theme for academics.**
...
If you've done the initial setup, open "Docker" and run the following commands from the directory of the website:
